package com.revature.woodgateP1.aspects;
...
public class AuthAspect {
    ...
    @Before("execution(* com.revature.woodgateP1.controllers.UserController.*(..)) " +
            "&& !execution(* com.revature.woodgateP1.controllers.UserController.registerUser(..))")
    ...
    @Before("@annotation(com.revature.woodgateP1.aspects.AdminOnly)")
